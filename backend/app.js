...
// Allow all origins (or configure specific domains)
app.use(cors());
...
//requiring generate-image
const generateImageRouter = require("./routes/generate-image.js");
...
app.use("/generate", generateImageRouter);
